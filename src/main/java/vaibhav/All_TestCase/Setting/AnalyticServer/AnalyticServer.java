...
import vaibhav.AllLocators.Setting.AnalyticServerLocators;
import vaibhav.Utils.GlobalWaits;

public class AnalyticServer extends GlobalWaits{
    ...
    public void editServer(WebDriver driver) {
        ...
        WebElement setting = driver.findElement(AnalyticServerLocators.SETTING);
        waitForElementToBeClickable(setting);
        setting.click();

        WebElement serverName = driver.findElement(AnalyticServerLocators.SERVER_NAME);
        waitForElementToBeClickable(serverName);
        serverName.click();

        driver.findElement(By.xpath("//div[@class=\"headingsDiv\"]/button")).click();

        WebElement nameField = driver.findElement(AnalyticServerLocators.NAME_INPUT);
        nameField.clear();
        nameField.sendKeys("Edit_GPU_Server");

        WebElement updateButton = driver.findElement(AnalyticServerLocators.UPDATE_BUTTON);
